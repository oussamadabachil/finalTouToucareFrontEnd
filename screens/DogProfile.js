...
export default function DogProfile() {
  ...
  let modifyBouton = (
    <View style={styles.boutonContainer}>
      <TouchableOpacity
        onPress={() => {
          handleModifyBouton(), setEditColor("darkgray");
        }}
        style={styles.button}
        activeOpacity={0.8}
      >
  ...
  return (
    ...
    >
      <View style={styles.main}>
        <ScrollView>
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, surnoms: text })
                }
                editable={editView}
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                ...
                editable={editView}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, date_de_naissanceDog: text })
                }
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, genre: text })
                }
                editable={editView}
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, race: text })
                }
                editable={editView}
                value={dogInfos.race}
              />
            ...
            <View style={styles.textInfoContainer}>
              ...
              <View style={styles.containerCheckbox}>
                <BouncyCheckbox
                  ...
                  onPress={(setChecked) =>
                    setDogInfos({ ...dogInfos, sterilisation: setChecked })
                  }
                  fillColor={"#008486"}
                  unfillColor={"white"}
                  size={30}
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, sante: text })
                }
                editable={editView}
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, caractere: text })
                }
                editable={editView}
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              <Text style={styles.text}>
                Mésententes avec certaines races de chiens ? :
              </Text>
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, mesententes_chiens: text })
                }
                editable={editView}
            ...
            <View style={styles.textInfoContainer}>
              ...
              <View style={styles.containerCheckbox}>
                <BouncyCheckbox
                  value={true}
                  onPress={(setChecked) =>
                    setDogInfos({ ...dogInfos, entente_chats: setChecked })
                  }
                  fillColor={"#008486"}
                  unfillColor={"white"}
                  size={30}
            ...
            <View style={styles.textInfoContainer}>
              ...
              <View style={styles.containerCheckbox}>
                <BouncyCheckbox
                  value={true}
                  onPress={(setChecked) =>
                    setDogInfos({ ...dogInfos, entente_enfants: setChecked })
                  }
                  fillColor={"#008486"}
                  unfillColor={"white"}
                  size={30}
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, habitudes: text })
                }
                editable={editView}
          ...
          <Pressable style={styles.singleInfoContainer} disabled={!editView}>
            <View style={styles.textInfoContainer}>
              ...
              <TextInput
                style={editView ? styles.inputStyleEdit : styles.textInput}
                onChangeText={(text) =>
                  setDogInfos({ ...dogInfos, peurs: text })
                }
                editable={editView}
      ...
      <View style={styles.footer}>{modifyBouton}</View>
    </KeyboardAvoidingView>
  );
}
